...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed May 18 05:31:40 2016
# Project:  BonesCoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile BonesCoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/BonesCoin/src/leveldb/libleveldb.a /tmp/BonesCoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: BonesCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile BonesCoin-qt.pro
...
/tmp/BonesCoin/src/leveldb/libleveldb.a: FORCE
	cd /tmp/BonesCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/BonesCoin/build/build.h: FORCE
	cd /tmp/BonesCoin; /bin/sh share/genbuild.sh /tmp/BonesCoin/build/build.h
